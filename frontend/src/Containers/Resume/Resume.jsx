                ...
                <Exp
                  ...
                  content={
                    <ul className="content__list">
                      <li>
                        Cooperating with Programmers to carry out testing home automation testing on
                ...
                <Exp
                  ...
                  content={
                    <ul className="content__list">
                      ...
                      <li>
                        Working along side A-grade Electrcian, undertaking specific instrucations to
                        complete tasks.
                      </li>
                ...
                <Exp
                  ...
                  content={
                    <ul className="content__list">
                      ...
                      <li>Noting cutting amounts, measurements and job numbers onto worksheets.</li>
              ...
              <>
                <Exp
                  ...
                  content={
                    <ul className="content__list">
                      <li>
                        egree will also provide you with a fundamental understanding of all aspects
                        of computing, computer hardware, operating systems, computer networks,
                        database systems, software engineering and organisational issues.{" "}
                      </li>
                    </ul>
                  }
                />
          ...
          <Dropdown
            ...
            content={
              <p className="p-text">
                ...
                Space Race and the innovation it brings, and I would like to witness a rocket launch
                in my lifetime. It is also important to me to keep up with web technology and UX
                design developments by listening to podcasts, attending local events, attending
                conferences, and using Twitter.
              </p>
            }
          />
